...
void main() {
  group('ProxyAnalytics', () {
    ...
    test('recordProxyFetch updates values correctly', () {
      ...
      final proxies = [
        Proxy(ip: '1.1.1.1', port: 8080, countryCode: 'US', anonymityLevel: 'elite'),
        Proxy(ip: '2.2.2.2', port: 8080, countryCode: 'CA', anonymityLevel: 'anonymous'),
      ];
      ...
      expect(updatedAnalytics.proxiesByAnonymityLevel, {'elite': 1, 'anonymous': 1});
    });
    ...
    test('recordProxyValidation updates values correctly', () {
      ...
      final updatedAnalytics = initialAnalytics.recordProxyValidation(proxies, results);
    ...
    test('toJson and fromJson work correctly', () {
      ...
      expect(fromJson.totalSuccessfulValidations, analytics.totalSuccessfulValidations);
      ...
      expect(fromJson.totalSuccessfulRequests, analytics.totalSuccessfulRequests);
      ...
      expect(fromJson.proxiesByAnonymityLevel, analytics.proxiesByAnonymityLevel);
